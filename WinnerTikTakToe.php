    ...
    <div class="container text-center text-break mt-5">
        ...
        <form method="post" action="tikTakToe.php">
            ...
            <div class="col bg-light shadow bg-opacity-75 py-5">
                <div class="row">
                    ...
                    <div class="col-12 margin">
                        <input class="form-control w-75 background color fw-semibold fs-5 text-center d-flex mx-auto" value="<?php echo $_GET["player1"];?>" name="Player1">
                    </div>
                </div>
            </div>
            <div class="col pt-2">
            <div class="row">
                ...
                <div class="col-12 style fs-1 fw-bolder mt-4">
                <?php
                    // if(isset($_GET["tie"])){
                    //     echo "<div class='alert alert-info'>","OOPS! its a tie 🥹","</div>";
                    // }
                    if(isset($_GET["msg"])){
                        echo "<div class='alert alert-info'>",$_GET["msg"],"</div>";
                    }
                    // if(isset($_GET["winner"])){
                    // echo "<div class='alert alert-info'>","Wohoooo! ",$_GET["winner"]," Won🥇","</div>";
                    // }
                    // else{
                    //     echo "<div class='alert alert-info'>","Wohoooo! ",$_GET["winner"]," Won🥇","</div>";
                    // }
                ...
                <button class="btn background bordered text-light text-center form-control shadow" name="play_btn">PLay Again</button>
                    </div>
            </div>
            </div>
            <div class="col bg-light shadow bg-opacity-75 py-5">
            ...
            <div class="col-12 margin">
                        <input class="form-control w-75 background color fw-semibold fs-5 text-center d-flex mx-auto" value="<?php echo $_GET["player2"];?>" name="Player2">
                    </div>
            </div>
            </div>
            </form>
